...
- After the BSL scope deduplication build, EDT still logged module-context-fallback from LCBuilderState-11:
  feature=module-context-fallback project=cf thread=LCBuilderState-11 moduleUri=platform:/resource/cf/src/CommonModules/ÃË„‡ˆËˇœËÎÓÊÂÌËÈ√ÎÓ·‡Î¸Ì˚È/Module.bsl.
...
- The log shows the remaining trigger: while the build was active, the open external data processor editor repeatedly ran ContentAssist resource sync and extended BSL containers/cache from cf.Ã‡„ÌËÚÃ‡ÍÂÚ.
