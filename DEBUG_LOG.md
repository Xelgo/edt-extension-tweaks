...
sample=[Doc, ThisObject, Р­С‚РѕС‚РћР±СЉРµРєС‚, Ext2_CommonModule, Ext2_CommonModule, Ext2_CommonModule1, ...]
```
...
context=FeatureEntry reference=feature
sample=[test4, test2, test3, test, ext2, ThisObject, Р­С‚РѕС‚РћР±СЉРµРєС‚, Ext1_CommonModule, ...]
```
...
```text
[module.context.provider] project=Configuration.Rest2
moduleUri=platform:/resource/Configuration.Rest2/src/CommonModules/Ext2_РћР±С‰РёР№РњРѕРґСѓР»СЊ3/Module.bsl
context=...{allMethods=0}
methods=[]
```
...
- For a fresh module such as `Ext2_РћР±С‰РёР№РњРѕРґСѓР»СЊ3`, `[module.context.provider]` may still show `allMethods=0`.
...
- Fresh log confirms the previous transient fallback suspicion is no longer the main path:
  `[module.context.provider]` for `Ext2_РћР±С‰РёР№РњРѕРґСѓР»СЊ4` shows `allMethods=1`, `methods=[РўРµСЃС‚]`, and a BM resource-backed
  context definition.
...
- Add a navigator property tester so the **РќР°СЃС‚СЂРѕРёС‚СЊ РєРѕРЅС‚РµРєСЃС‚ EDT** menu item is visible only for extension projects.
...
- Adding an attribute to `Extension2` (`Document Р Р°СЃС€2_Р”РѕРєСѓРјРµРЅС‚.Р РµРєРІРёР·РёС‚3`) starts an EDT background model rebuild.
...
- On extension changes, the listener queued both sides:
  `changed=[...Р Р°СЃС€РёСЂРµРЅРёРµ2] ... dependentProjects/previous projects include [...Р Р°СЃС€РёСЂРµРЅРёРµ]`.
...
- Need to research the EDT Query Constructor ("РљРѕРЅСЃС‚СЂСѓРєС‚РѕСЂ Р·Р°РїСЂРѕСЃРѕРІ").
...
```text
EDT Context Links QL BM global scope wrapper registered
EDT Context Links QL BM provider call resource=com._1c.g5.v8.bm.core.internal.BmResource project=РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ ql=false
...
```text
EDT Context Links QL BM global scope wrapper registered
EDT Context Links QL BM provider call resource=com._1c.g5.v8.bm.core.internal.BmResource project=РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ ql=false uri=bm://РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ/Configuration
EDT Context Links QL BM provider call resource=com._1c.g5.v8.dt.ql.dcs.resource.QlDcsResource project=РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ2 ql=true uri=platform:/resource/РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ2/querywizard_1781363970873.qldcs
EDT Context Links QL BM scope project=РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ2 linked=[РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ] skipped=[РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ]
```
...
- For `РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ2`, the wrapper adds the linked sibling extension `РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ` and skips the base
  configuration as intended.
- Remaining uncertainty: this only proves scope injection for the opened `Р Р°СЃС€РёСЂРµРЅРёРµ2` query constructor resource. Need functional
...
EDT Context Links QL BM global scope wrapper registered
EDT Context Links startup warm-up scheduled
EDT Context Links startup warm-up pass=1 projects=[РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ2, РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ]
EDT Context Links startup warm-up build pass=1 project=РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ2
EDT Context Links startup warm-up build pass=1 project=РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ
EDT Context Links QL BM provider call resource=com._1c.g5.v8.dt.ql.dcs.resource.QlDcsResource project=РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ2 ql=true uri=platform:/resource/РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ2/querywizard_1781364155235.qldcs
EDT Context Links QL BM scope project=РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ2 linked=[РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ] skipped=[РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ]
EDT Context Links startup warm-up pass=2 projects=[РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ2, РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€РёСЂРµРЅРёРµ]
```
...
- The linked extension scope is still being composed for `Р Р°СЃС€РёСЂРµРЅРёРµ2`.
...
## 2026-06-13 - Targeted QL Probe for `Р Р°СЃС€1_Р”РѕРєСѓРјРµРЅС‚`

User scenario:

- Open module `Р Р°СЃС€2_РћР±С‰РёР№РњРѕРґСѓР»СЊ` in `Р Р°СЃС€РёСЂРµРЅРёРµ2`.
- Open Query Constructor from that module.
- Current Query Constructor only shows `Р Р°СЃС€2_Р”РѕРєСѓРјРµРЅС‚` and `Р Р°СЃС€2_РЎРїСЂР°РІРѕС‡РЅРёРє`.
- It should also show objects from `Р Р°СЃС€РёСЂРµРЅРёРµ1`, first target for diagnosis: `Р Р°СЃС€1_Р”РѕРєСѓРјРµРЅС‚`.

Hypothesis to split:

- If `Р Р°СЃС€1_Р”РѕРєСѓРјРµРЅС‚` is present in the linked/composite QL BM scope, but Query Constructor UI still does not show it, then the
  next missing layer is likely a QL-DCS/querywizard db-view model or cache built above the global BM scope.
- If `Р Р°СЃС€1_Р”РѕРєСѓРјРµРЅС‚` is absent from the linked scope itself, then the current `EReference`/filter used by QL's BM provider
...
- Log whether target `Р Р°СЃС€1_Р”РѕРєСѓРјРµРЅС‚` is found, how many elements were scanned, whether scanning was truncated, and up to five
...
EDT Context Links QL probe phase=linked ... target=Р Р°СЃС€1_Р”РѕРєСѓРјРµРЅС‚ found=...
EDT Context Links QL probe phase=composite ... target=Р Р°СЃС€1_Р”РѕРєСѓРјРµРЅС‚ found=...
```
...
```text
РЈСЃС‚Р°РЅРѕРІРєР° ru.xelgo.edt.contextlinks.feature.feature.group 1.0.0.v202606131532.
Add Р·Р°РїСЂРѕСЃ РґР»СЏ EDT Context Links 1.0.0.v202606131532 ... РІС‹РїРѕР»РЅРµРЅ
РћРїРµСЂР°С†РёСЏ Р·Р°РІРµСЂС€РµРЅР° Р·Р° 26111 РјСЃРµРє.
```
...
- Functional screenshot check showed Query Constructor opened from `Р Р°СЃС€2_РћР±С‰РёР№РњРѕРґСѓР»СЊ`; under `РЎРїСЂР°РІРѕС‡РЅРёРєРё` only
  `Р Р°СЃС€2_РЎРїСЂР°РІРѕС‡РЅРёРє` was visible. `Р Р°СЃС€1_РЎРїСЂР°РІРѕС‡РЅРёРє` was still absent.
...
```text
java.lang.IllegalArgumentException: Line does not contain at least 5 tokens: РїВ»С—#encoding=UTF-8
```
...
- Good state preserved:
  - `Ctrl+Alt+Q`, then `Tab`, then right arrows opens Query Wizard and shows linked `Р Р°СЃС€1_РЎРїСЂР°РІРѕС‡РЅРёРє`.
...
- Current bug is not fixed:
  - Clicking/adding linked `Р Р°СЃС€1_РЎРїСЂР°РІРѕС‡РЅРёРє` into the center `Tables` area still gives the wrong icon/semantics.
...
- Observed after redeploy:
  - `РЎРїСЂР°РІРѕС‡РЅРёРє_РєРѕРЅС„РёРіСѓСЂР°С†РёРё` fields are visible again in the database tree.
  - `Р Р°СЃС€2_Р”РѕРєСѓРјРµРЅС‚` and `Р Р°СЃС€2_РЎРїСЂР°РІРѕС‡РЅРёРє` are still absent from the Query Wizard database tree opened from `Р Р°СЃС€1_РћР±С‰РёР№РњРѕРґСѓР»СЊ`.
  - `Р Р°СЃС€2_Р РµРєРІРёР·РёС‚` is still collected as an adoption candidate when pressing `OK` from `Р Р°СЃС€1`; EDT still wants to add it to `Р Р°СЃС€1`, which must not happen for metadata owned by another extension.
  - The middle table list can still show `РЎРїСЂР°РІРѕС‡РЅРёРє_РєРѕРЅС„РёРіСѓСЂР°С†РёРё`, `РЎРїСЂР°РІРѕС‡РЅРёРє_РєРѕРЅС„РёРіСѓСЂР°С†РёРё1`, etc. when the user adds fields from the database tree.
- Log clue:
...
- Next attempt:
  ...
  - Add an `IModelObjectAdopter` wrapper: inside `QueryWizardAdoptSupport`, treat objects owned by a different `IExtensionProject` as already adopted, so Query Wizard skips the "add to current extension" prompt for `Р Р°СЃС€2_*` fields while keeping normal adoption for base configuration objects.
...
- User-visible result is bad:
  - `Р Р°СЃС€2_Р”РѕРєСѓРјРµРЅС‚` and `Р Р°СЃС€2_РЎРїСЂР°РІРѕС‡РЅРёРє` still do not appear in Query Wizard from `Р Р°СЃС€1`.
  - `РЎРїСЂР°РІРѕС‡РЅРёРє_РљРѕРЅС„РёРіСѓСЂР°С†РёРё` duplicate/table selection bug remains.
...
- `Ctrl+Alt+Q` from `Р Р°СЃС€1_РћР±С‰РёР№РњРѕРґСѓР»СЊ` reaches the QL wrapper again.
- The QL probe shows the composite contains linked `Р Р°СЃС€2_РЎРїСЂР°РІРѕС‡РЅРёРє` and `Р Р°СЃС€2_Р”РѕРєСѓРјРµРЅС‚`.
...
- The probe explains why:
  - own scope has `Catalog.РЎРїСЂР°РІРѕС‡РЅРёРє_РєРѕРЅС„РёРіСѓСЂР°С†РёРё`;
  - linked scope has another `Catalog.РЎРїСЂР°РІРѕС‡РЅРёРє_РєРѕРЅС„РёРіСѓСЂР°С†РёРё`;
...
- Query Wizard opened from `Р Р°СЃС€1_РћР±С‰РёР№РњРѕРґСѓР»СЊ` without the previous `Expected an instance of BmObject` warning.
...
project=РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€1 ql=true
```

- Composite QL scope now has current project objects first:
  - `Catalog.Р Р°СЃС€1_РЎРїСЂР°РІРѕС‡РЅРёРє`;
  - `Document.Р Р°СЃС€1_Р”РѕРєСѓРјРµРЅС‚`;
  - `Catalog.РЎРїСЂР°РІРѕС‡РЅРёРє_РєРѕРЅС„РёРіСѓСЂР°С†РёРё` from `РљРѕРЅС„РёРіСѓСЂР°С†РёСЏ.Р Р°СЃС€1`;
  - then linked unique objects `Catalog.Р Р°СЃС€2_РЎРїСЂР°РІРѕС‡РЅРёРє` and `Document.Р Р°СЃС€2_Р”РѕРєСѓРјРµРЅС‚`.
- This confirms the `Р Р°СЃС€2_*` objects are back in the QL context and the same-name base catalog no longer shadows the current project with the linked extension object.
- Remaining work:
...
- User confirmed `Р Р°СЃС€2_РЎРїСЂР°РІРѕС‡РЅРёРє` and `Р Р°СЃС€2_Р”РѕРєСѓРјРµРЅС‚` are visible when the Query Wizard button hiding base-configuration
...
```text
Р—Р°РїСЂРѕСЃ РёСЃРїРѕР»СЊР·СѓРµС‚ РѕР±СЉРµРєС‚С‹, РѕС‚СЃСѓС‚СЃС‚РІСѓСЋС‰РёРµ РІ СЂР°СЃС€РёСЂРµРЅРёРё РєРѕРЅС„РёРіСѓСЂР°С†РёРё.
Р”РѕР±Р°РІРёС‚СЊ РёСЃРїРѕР»СЊР·СѓРµРјС‹Рµ РѕР±СЉРµРєС‚С‹ РІ СЂР°СЃС€РёСЂРµРЅРёРµ РєРѕРЅС„РёРіСѓСЂР°С†РёРё?
```
...
- Desired behavior:
  ...
  - this must apply both to root metadata objects like `Р Р°СЃС€2_РЎРїСЂР°РІРѕС‡РЅРёРє`/`Р Р°СЃС€2_Р”РѕРєСѓРјРµРЅС‚` and their fields.
- New attempt:
...
- Retried the documented bootstrap twice after `@РљРѕРјРїСЊСЋС‚РµСЂ` was explicitly invoked.
